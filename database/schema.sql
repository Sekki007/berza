...
CREATE TABLE users (
    ...
    shop_slug VARCHAR(60) NULL UNIQUE,
    ...
    notify_telegram_messages TINYINT(1) NOT NULL DEFAULT 1,
    notify_telegram_alerts TINYINT(1) NOT NULL DEFAULT 1,
    notify_telegram_system TINYINT(1) NOT NULL DEFAULT 1,
    telegram_chat_id VARCHAR(64) NULL,
    telegram_username VARCHAR(80) NULL,
    telegram_link_code VARCHAR(16) NULL,
    ...
    business_kind VARCHAR(20) NULL,
    pib VARCHAR(20) NULL,
    business_status VARCHAR(20) NOT NULL DEFAULT 'none',
    business_requested_at DATETIME NULL,
    business_verified_at DATETIME NULL,
    business_reject_reason VARCHAR(255) NULL,
